...
class PathParameterizerTOPPRA:
    ...
    def generate(self, path: roboplan_ext.core.JointPath, dt: float, mode: SplineFittingMode = SplineFittingMode.Hermite, velocity_scale: float = 1.0, acceleration_scale: float = 1.0, max_adaptive_iterations: int = 10, max_adaptive_step_size: float = 0.05) -> roboplan_ext.core.JointTrajectory:
