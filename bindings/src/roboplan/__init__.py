...
from .roboplan_ext import filters as _filters
from .roboplan_ext import optimal_ik as _optimal_ik
...
sys.modules[__name__ + ".filters"] = _filters
sys.modules[__name__ + ".optimal_ik"] = _optimal_ik
