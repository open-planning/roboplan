...
#
# Each package resolves siblings via find_package(<name> REQUIRED), expecting an
# installed package, so it stays buildable standalone. To make that work in an
# uninstalled build tree, we pre-register a near-empty fake "<name>Config.cmake"
# for each package and point <name>_DIR at it. find_package(CONFIG) checks
# <name>_DIR before CMAKE_PREFIX_PATH, so this makes find_package(<name>
# REQUIRED) succeed without a real install.
#
...
# <name>_DIR half, not aliasing, and isn't an option anyway: ROS Humble ships
# CMake 3.22.)

function(roboplan_register_build_tree_package package_name)
  set(_package_dir
      "${PROJECT_BINARY_DIR}/superbuild-package-configs/${package_name}")
  file(MAKE_DIRECTORY "${_package_dir}")
  file(
    WRITE "${_package_dir}/${package_name}Config.cmake"
  ...
  set(${package_name}_DIR
      "${_package_dir}"
      CACHE PATH "Build-tree ${package_name} package config" FORCE)
endfunction()
