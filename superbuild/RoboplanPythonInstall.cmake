...
# retain their local fallback when this module is absent. Set
# ROBOPLAN_PYTHON_INSTALL_DIR to override the destination; it may be relative to
# CMAKE_INSTALL_PREFIX or an absolute site-packages path.
function(roboplan_get_python_install_dir result)
  if(DEFINED ROBOPLAN_PYTHON_INSTALL_DIR)
    set(${result}
        "${ROBOPLAN_PYTHON_INSTALL_DIR}"
        PARENT_SCOPE)
