...
struct SingularityBarrier : public Barrier {
  /// @brief Construct a singularity barrier.
  ...
  SingularityBarrier(const Oink& oink, const Scene& scene, const std::string& frame_name, double dt,
                     double sigma_safe, double gain = 1.0, double safe_displacement_gain = 1.0,
                     double safety_margin = 0.0, double fd_epsilon = 1e-6);
