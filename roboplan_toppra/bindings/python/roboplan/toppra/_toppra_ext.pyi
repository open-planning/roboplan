...
class PathParameterizerTOPPRA:
    ...
    def generate(self, path: roboplan.core._core_ext.JointPath, dt: float, mode: SplineFittingMode = SplineFittingMode.Hermite, velocity_scale: float = 1.0, acceleration_scale: float = 1.0, max_adaptive_iterations: int = 10, max_adaptive_step_size: float = 0.05, max_deviation: float = 0.01) -> roboplan.core._core_ext.JointTrajectory:
